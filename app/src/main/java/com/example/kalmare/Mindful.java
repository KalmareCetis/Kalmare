...
public class Mindful extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto = getResources().getStringArray(R.array.mind);

        TextView fadingText = findViewById(R.id.text_fade);

        updateTextPeriodically(fadingText, 8000);
    }
    ...
    public void vuelve(View v) {
        Intent volver = new Intent(Mindful.this, Respira.class);
        startActivity(volver);
    }
    public void iniciar() {
        destruir();
        musica = MediaPlayer.create(this, R.raw.kalimbados);
        musica.start();
